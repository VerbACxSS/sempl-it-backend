...
async def simplify(request: SimplificationRequest,
    ...
    try:
        ...
        # Simplify the text
        # simplification_progress = simplification_service.simplify(request.text, mode="openai")
        simplification_progress = simplification_service.simplify(request.text, mode="sempl-it")
        simplified_text = simplification_progress['sentence_reorganizer']
